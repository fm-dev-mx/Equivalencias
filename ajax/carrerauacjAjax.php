<?php
	...
	if(isset($_POST['nombreCarreraUacjAgregar']) || isset($_POST['codigo-del']) || isset($_POST['privilegio-admin']) || isset($_POST['CarreraNombreUpdate']) || isset($_POST['CarreraCodigoUpdate']) || isset($_POST['uniSelect']) || isset($_POST['carreraSelect'])){
